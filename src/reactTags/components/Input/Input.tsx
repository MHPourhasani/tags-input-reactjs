...
const Input = ({ theme, placeholder, setShowDropdown, value, changeHandler, keyDown, inputClassName, selectedTags }: InputProps) => {
    return (
        <input
            ...
            className={`flex-1 py-1 px-4 rounded-[10px] outline-none ml-4 !text-right placeholder:text-right bg-transparent placeholder:text-sm placeholder:text-zSecondary-400 ${
